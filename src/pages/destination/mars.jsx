...
export default function Moon() {
  ...
  const dataContext = useContext(destinationsContext);
  console.log(dataContext);
  useEffect(() => {
    if (location.pathname === "/destination/mars") {
